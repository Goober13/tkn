...
if ($key == '1') {
    ...
    if (preg_match('/Nomor HP ini tidak valid/', $login_with_phone[1])) {
        ...
        if (preg_match('/access_token/', $verify[1])) {
            ...
            $order = request('https://api.gojekapi.com/gopoints/v1/orders', '{"gopay_pin":"","payment_type":"points","voucher_batch_id":"e8752d86-808e-4ad5-8a46-fa1569446064","voucher_count":1}', null, $header_login);
